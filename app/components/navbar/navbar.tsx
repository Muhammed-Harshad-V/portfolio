...
export default function Navbar() {
  ...
  return (
    <div className="w-full sm:h-[50px] md:h-[70px] lg:h-[85px] bg-black font-mono border-b border-b-retroGreen grid grid-cols-[3fr_1fr_1fr] items-center pr-3 pl-3 drop-shadow-greenGlow">
      <Link href="/" passHref className='h-full border-r border-retroGreen'>
      ...
      <Link href="/projects" passHref className='h-full border-r border-retroGreen'>
        <p className={`sm:text-[12px] md:text-[14px]  xl:text-[16px] font-mono ${isActive('/projects')} text-white h-full flex items-center justify-center pr-2 pl-2`}>
          /Projects/
        </p>
      </Link>
