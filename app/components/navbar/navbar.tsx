  ...
  return (
    <div className="w-full sm:h-[50px] md:h-[70px] bg-black font-mono border-b border-b-retroWhite grid grid-cols-[3fr_1fr_1fr] items-center pr-3 pl-3 drop-shadow-whiteGlow">
      ...
      <Link href="/projects" passHref className='h-full border-r border-retroWhite'>
        <p className={`sm:text-[12px] md:text-[14px] font-mono ${isActive('/projects')} text-white h-full flex items-center justify-center pr-2 pl-2`}>
          /Projects/
        </p>
      </Link>

      <Link href="/contact" passHref>
        <p className={`sm:text-[12px] md:text-[14px] font-mono ${isActive('/contact')} text-white h-full flex items-center justify-center pl-2`}>
          /Contact/
        </p>
      </Link>
    </div>
